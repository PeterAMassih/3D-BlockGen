...
class LegoConverter:
    def __init__(self):
        ...
        # TODO Add the rest of the brick sizes if want to use them
                    ...
                    if voxels[3, x, y, z] > 0 and not occupied[0, x, y, z]:
                        ...
                        for size in self.brick_sizes:
                            if self._check_space_available(occupied, (x, y, z), size):
                                ...
                                if region.sum() == size[0] * size[1] * size[2] and self._check_support(occupied,
                                                                                                       (x, y, z), size,
                                                                                                       -1):
                                    best_size = size
                                    break
...
if __name__ == "__main__":
    voxel_data = torch.load('path_to_your_voxel.pt')  # CHANGE THIS TO THE .pt you want or check run.ipynb

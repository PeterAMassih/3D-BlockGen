# blockgen/scripts/train.py
# Train script similar to finetune.py
...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str, default='objaverse_data_voxelized',
                        help='Directory containing voxel data')
...
def main():
    ...
    train_params = {
        'batch_size': 4,
        'test_split': 0.05,
        # We have 135560 3d objects * 4 augmentation 0.05 is 6778 so 128782 normal steps we use 129k
        'total_steps': 129_000,
        'save_every': 10_000,
        'eval_every': 10_000,
        'initial_lr': 1e-4,
